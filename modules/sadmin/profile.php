...
if(isset($_SESSION['id']) && isset($_SESSION['username'])){
    ...
    <html>
    <head>
        <title><?php echo $fname.' '.$lname ?>-SAdmin</title>
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
                    <div class="container" style="border-bottom:1px solid black">
                        <h2><?php echo $fname.' '.$lname.' ('.ucfirst($position).': Main Center)'; ?></h2>
                    </div>
                    <hr>
                    <ul class="container details">
                        <li><p><span class="glyphicon glyphicon-ok-sign" style="width:50px;"></span><?php echo $eid.' ( SAdmin)'; ?></p></li>
                        ...
                        <li><p><span class="glyphicon glyphicon-map-marker one" style="width:50px;"></span><?php echo " BLDEACET "?></p></li>
