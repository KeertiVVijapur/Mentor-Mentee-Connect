...
<head>
    ...
    <title><?php echo 'Complaint Id-'.$get_complaintid; ?>-reply</title>
...
<?php
    if(isset($_POST['submit'])){
        $complaint_reply = $_POST['complaintreply'];
            ...
            $sql_update = "UPDATE complaint SET reply='$complaint_reply',dateofreply='$today_date',replyed='1' WHERE id='$get_complaintid'";
