...
<?php
        ...
        if(isset($_POST['search_student'])){
            ...
            if ($search_student_q_ch <= 0){
                ...
                <div align="center">
                    ...
                    <p><b>Timings: </b><?php echo $as['timing'] ;?></p>
    ...
    if(isset($_GET['batch'])){ ?>
        <div align="center">
            <h3>Batch Details</h3>
            <form method="post">
                <b>Center: </b><input type="text" name="centerid" placeholder="Enter Center"><br>
