        ...
        if(!isset($_GET['addadmin']) AND !isset($_GET['updateadmin']) AND !isset($_GET['addcenters'])  AND !isset($_GET['updatecenter'])){
            ...
            if(isset($_GET['addcenters'])){?>
                ...
                <div align="center">
                    ...
                    <form method="post">
                        <b>Center ( <span style="color: lightslategrey">BLDEACET</span>): </b><input type="text" name="center" placeholder="Enter Center Code" >
                        ...
                        <b>Enter Course<span style="color: red;">*</span> ( <span style="color: lightslategrey">like ISE</span>): </b><input type="text" name="course" placeholder="Enter Course"><br><span style="color: red; font-size: 10px">* Only One course at a time. For more courses click on add center and add center again.</span>
