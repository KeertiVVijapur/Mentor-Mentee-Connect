...
if(isset($_SESSION['id']) && isset($_SESSION['username'])){
    ...
    $ydate = date('Y-m-d');
$day = date("l");
$find_admin_sql = "SELECT * FROM teachers WHERE position = 'sadmin'";
...
if($findrows = mysqli_fetch_assoc($find_admin_result)){
    ...
    $admin_eid = "sAdmin Does not Exist";
}
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>Complaint-Mentor-ISE</title>
...
<div id="mySidenav" class="sidenav">
    ...
    <a href="index.php" class="logo"><span style="color:red;font-size:30px">ISE</span></a>
